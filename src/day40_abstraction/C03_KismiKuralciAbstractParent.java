...
public abstract class C03_KismiKuralciAbstractParent {
    /*
    bir class isterse kendisini parent edecek child class ların
    mutlaka implement etmesi gereken methodları belirleyebilir

    orneğin bu classımız kendisinde bulunan method1 ve method2 yi
    C03 u parent edinen tum child class ların implement etmesini zorunlu kılmak istiyor
     */
    /*
