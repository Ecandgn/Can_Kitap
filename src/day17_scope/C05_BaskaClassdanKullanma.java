...
public class C05_BaskaClassdanKullanma {
    public static void main(String[] args) {
        ...
        Static variable ve methodlara başka class dan oluşmak için classIsmi.classUyesiIsmi kullanılır
        ...
        C04_StaticVariablesVsInstanceVariables personel=new C04_StaticVariablesVsInstanceVariables();
